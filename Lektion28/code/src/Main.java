...
public class Main {
    ...
    public static void printConvertResult(int amountCurrency, int currencyIndex, int convertCurrencyIndex) {
    ...
    public static int getInputCode(String str, int maxValue) {
        ...
        while (true) {
            try {
                ...
                if (!Objects.equals(str, "")) System.out.print(str);
                code = sc.nextInt();
