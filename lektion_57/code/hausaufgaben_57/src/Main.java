...
public class Main {
    ...
    /**
     *  2. Написать метод, возвращающий слова в строке в обратном порядке.
     ...
     *    Write a method to convert a string of lowercase letters into a string counting
     *    the number of these letters for each letter aaaabbccccd -> 4a2b4cd
